...
public class CurrencyController {
    ...
    private final CurrencyBCFallback currencyBCFallback;
	 ...
	 public CurrencyController(CurrencyRepository repository, CurrencyBCClient currencyBCClient, CacheManager cacheManager, CurrencyBCFallback currencyBCFallback) {
		super();
			 ...
			 if (source.equals(target)) {
				 ...
				 try {
					...
					currency = repository.findBySourceAndTarget(source, target) 
							.orElseThrow(() -> new Exception("Currency Unsupported" + e.getMessage() ));
